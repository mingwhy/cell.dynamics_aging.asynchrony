...
for(cut.off.value in cut.offs){
  ...
  output.file=paste0('mouse_male_binary_TDI_ts_',cut.off.value,'_24m.rds')  
  #output.file=paste0('mouse_male_binary_TDI_ts_',cut.off.value,'_24m_filter.dnds1.rds')
